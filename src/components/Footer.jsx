    ...
    <div className="footer">
      <div className="container">
        ...
        <div className="footer-form">
          <form action="#">
            <input type="text" className='footer-form-input' placeholder='Enter your email address' required />
            <input type='button' className='footer-form-btn' value='Explore Now'/>
          </form>
        </div>
      </div>
      <Head 
